...
class TestOSMLayer(unittest.TestCase):
    def test_OSMLayer_init(self):
        ...
        self.assertEqual([layer.dicosmn, layer.dicosmw, layer.dicosmr, layer.dicosmfirst, layer.dicosmtags], layer.dicosm)

    def test_update_dicosm(self):
        layer = OSM.OSM_layer()
        osm_file = open(os.path.join(os.path.dirname(__file__), 'mocks/osm_get_aeroways.xml'))
        ...
        self.assertEqual([-17, -7203, -1412, -7204, -7135, -7184, -5864, -7040, -7056, -1411, -5859], layer.dicosmw[-10])
        ...
        self.assertEqual([-5138, -5140, -5122, -5121, -5128, -5123, -5117, -5094, -5100, -5097, -5088, -5058,
                                ...
                                -5142, -5138], layer.dicosmr[-1]['outer'])
        ...
        self.assertEqual([-5138, -5140, -5371, -9611, -506, -5370, -9607, -9606, -9612, -9613, -9608, -9599,
                                ...
                                -5142, -5138], layer.dicosmr[-2]['outer'])
        # tags
    ...
    def test_update_dicosm_with_uncompressed_file(self):
        layer = OSM.OSM_layer()
        file_path_string = os.path.join(os.path.dirname(__file__), 'mocks/osm_get_aeroways.xml')
    ...
    def test_update_dicosm_with_bz2_file(self):
        layer = OSM.OSM_layer()
        file_path_string = os.path.join(os.path.dirname(__file__), 'mocks/osm_get_aeroways.xml.bz2')
    ...
    def test_malformed_xml_data(self, vprint_mock):
        ...
        layer = OSM.OSM_layer()
        file_path_string = os.path.join(os.path.dirname(__file__), 'mocks/osm_malformed.xml')
...
class TestGetOverpassData(unittest.TestCase):
    ...
    def test_get_overpass_data_with_string(self, session_mock):
        ...
        osm_file = open(os.path.join(os.path.dirname(__file__), 'mocks/osm_get_motorway.xml'))
